...
CREATE 
    ...
    (
        ...
        lean_product_development:Construct:Product_And_Process {
            ...
            key_capability: "product_and_process"
        }
    ),(
        change_approvals:Construct:Product_And_Process {
            ...
            key_capability: "product_and_process",
            tip: "Nous n'avons pus besoin des mêmes processus pour appliquer des changements."
        }
    ),(
        lean_management:Construct:LeanManagement_And_Monitoring {
            ...
            key_capability: "lean_management_and_monitoring"
        }
    ),(
        ...
        organizational_performance:Construct:Outcome {
            ...
            tip: "Profitabilité, productivité et parts de marchés.",
            key_capability: "outcome"
        }
    ),(
    ...
    (
        vision:Capability:Cultural {
            ...
            tip: "Je vois pourquoi je fais ce que je fais.",
            key_capability: "cultural"
        }
    ),(
        inspirational_communication:Capability:Cultural {
            ...
            tip: "Quand je l'entends parler, cela me donne envie.",
            key_capability: "cultural"
        }
    ),(
        intellectual_stimulation:Capability:Cultural {
            ...
            description: "Communiquer d'une manière qui inspire et motive, même dans un environnement incertain ou changeant.",
            tip: "Les sujets que j'aborde sont de beaux défis qui puisent dans mes capacités intellectuelles.",
            key_capability: "cultural"
        }
    ),(
        supportive_leadership:Capability:Cultural {
            ...
            tip: "Je sais que je peux m'appuyer sur cette personne.",
            key_capability: "cultural"
        }
    ),(
        personal_recognition:Capability:Cultural {
            ...
            tip: "Je sais quand j'ai fait du bon travail.",
            key_capability: "cultural"
        }
    ),(
        test_automation:Capability:Technical {
            ...
            tip: "Tester, c'est douter ! Tester, c'est fastidieux. Sauf quand j'ai juste besoin d'appuyer sur le bouton."
        }
    ),(
        deployment_automation:Capability:Technical {
            ...
            tip: "Livrer un carton, c'est simple comme bonjour.",
            key_capability: "technical"
        }
    ),(
        trunk_based_development:Capability:Technical {
            ...
            tip: "Nous avons un flux de travail avec deux branches.",
            key_capability: "technical"
        }
    ),(
        shift_left_on_security:Capability:Technical {
            ...
            tip: "Vous avez du mal à vous protéger des intrusions ? Est-il un peu Sec votre DevOps ?",
            key_capability: "technical"
        }
    ),(
        loosely_coupled_architecture:Capability:Technical {
            ...
            tip: "Nos services sont très indépendants, ce qui nous rend bien plus résilients.",
            key_capability: "technical"
        }
    ),(
        autonomous_team:Capability:Technical {
            ...
            tip: "Nous avons la liberté de choisir nos propres outils de travail.",
            key_capability: "technical"
        }
    ),(
        continuous_integration:Capability:Technical {
            ...
            tip: "Avec notre pipeline, on met les pleins gaz.",
            key_capability: "technical"
        }
    ),(
        ...
        version_control:Capability:Technical {
            ...
            tip: "Je tague un fix, puis je crée une branche.",
            key_capability: "technical"
        }
    ),(
        test_data_management:Capability:Technical {
            ...
            tip: "Tester sans données fiables c'est très compliqué.",
            key_capability: "technical"
        }
    ),(
        monitoring_and_observability:Capability:Technical {
            ...
            tip: "Notre tableau contient la réponse à la Question Ultime sur la Vie, l'Univers et Tout le reste.",
            key_capability: "technical"
        }
    ),(
        proactive_notifications:Capability:Technical {
            ...
            tip: "Une personne avertie en vaut deux !",
            key_capability: "technical"
        }
    ),(
        ...
        visibility_of_work:Capability:Product_And_Process {
            ...
            tip: "Cela peut se faire par VSM ou une cartographie des flux.",
            key_capability: "product_and_process"
        }
    ),(
        customer_feedback:Capability:Product_And_Process {
            ...
            guide: "https://cloud.google.com/solutions/devops/devops-process-customer-feedback",
            tip: "Nous faisons régulièrement une démo du produit au client.",
            key_capability: "product_and_process"
        }
    ),(
        team_experimentation:Capability:Product_And_Process {
            ...
            guide: "https://cloud.google.com/solutions/devops/devops-process-team-experimentation",
            tip: "Mon équipe n'a pas peur que cela fasse BOUM !",
            key_capability: "product_and_process"
        }
    ),(
        ...
        limit_wip:Capability:LeanManagement_And_Monitoring {
            ...
            tip: "Ralentir pour accélérer ? Arrêter de commencer et commencer à terminer ? C'est fou !",
            key_capability: "lean_management_and_monitoring"
        }
    ),(
        visual_management:Capability:LeanManagement_And_Monitoring {
            ...
            tip: "Personne ne nous demande ce que l'ont fait. N'importe qui peut le voir au tableau",
            key_capability: "lean_management_and_monitoring"
        }
    ),(
        feedback_from_production:Capability:LeanManagement_And_Monitoring {
            ...
            tip: "J'ai accès aux logs et aux bonnes métriques pour pouvoir prendre des décisions métier.",
            key_capability: "lean_management_and_monitoring"
        }
    ),(
        ...
        continuous_delivery:Capability:Technical {
            ...
            tip: "Livrer dans 5 min ? Un vendredi soir ? Pas de soucis ! On déploie quand tu le veux et autant de fois que tu le veux.",
            key_capability: "technical"
        }
    ),(
    ...
    (
        ...
        westrum_organizational_culture:Outcome:Culture_and_Work_Environment {
            ...
            tip: "Pathologique, bureaucratique ou générative : C'est une question de culture.",
            key_capability: "outcome"
        }
    ),(
        ...
        job_satisfaction:Outcome:Culture_and_Work_Environment {
            ...
            tip: "J'ai tous les outils qu'il me faut. Je me sens bien, en sécurité et valorisé·e.",
            key_capability: "outcome"
        }
    ),(
        identity:Outcome:Culture_and_Work_Environment {
            ...
            tip: "Mon entreprise me ressemble.",
            key_capability: "outcome"
        }
    ),(
        ...
        non_commercial_performance:Outcome:Organizational_Performance {
            ...
            tip: "Nos clients sont de plus en plus satisfaits.",
            key_capability: "outcome"
        }
    ),(
        ...
        less_deployment_pain:Outcome {
            ...
            tip: "Agir vite en cas d'urgence, comme une ambulance, mais sans souffrance !",
            key_capability: "outcome"
        }
    ),(
        less_rework:Outcome {
            ...
            tip: "Ce qui est fait n'est pas à refaire.",
            key_capability: "outcome"
        }
    ),
